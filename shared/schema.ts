...
// Token holders table (tracks user token balances)
export const tokenHolders = pgTable("token_holders", {
  ...
  tokenAddressIdx: index("token_holders_token_address_idx").on(table.tokenAddress),
  holderAddressIdx: index("token_holders_holder_address_idx").on(table.holderAddress),
  balanceIdx: index("token_holders_balance_idx").on(table.balance),
  uniqueHolding: index("token_holders_unique_idx").on(table.tokenAddress, table.holderAddress),
}));
