                ...
                <Card className="w-full bg-[#1f201e] rounded-2xl border border-solid border-[#2e2e2d] shadow-shadow overflow-x-auto lg:overflow-hidden">
                    ...
                    <CardContent className="p-2.5">
                        ...
                        <div className="min-w-[1000px] lg:min-w-0 px-2.5">
                            {/* Column headers */}
                            <div className="w-full h-[30px] rounded-lg border-[0.6px] border-solid border-[#beb7c4] grid grid-cols-[1fr_1.5fr_0.8fr_1.5fr_1.2fr_1.2fr] gap-4 items-center px-4 mb-2">
                            ...
                            <div className="flex flex-col pb-4">
                                {blockRows.map((row) => (
                                    <div
                                        key={row.id}
                                        className="w-full min-h-[50px] grid grid-cols-[1fr_1.5fr_0.8fr_1.5fr_1.2fr_1.2fr] gap-4 items-center px-4 border-b border-[#2e2e2d] last:border-0 hover:bg-[#ffffff05] transition-colors"
                                    >
                                        {/* HEIGHT */}
                                        <div className="flex justify-start">
                                            <div className="bg-[#ffffff12] rounded px-2 py-1">
                                        ...
                                        {/* TXN */}
                                        <div className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-white text-xs tracking-[0] leading-[normal] text-center">
                                            {row.txn}
                                        </div>
