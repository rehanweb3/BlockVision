                ...
                <Card className="w-full bg-white rounded-2xl border border-solid border-[#5b616e33] shadow-shadow overflow-x-auto lg:overflow-hidden">
                    ...
                    <CardContent className="p-2.5">
                        ...
                        <div className="min-w-[1240px] lg:min-w-0 px-2.5">
                            {/* Column headers */}
                            <div className="w-full h-[30px] rounded-lg border-[0.6px] border-solid border-[#8a91a0] grid grid-cols-[1.5fr_1.5fr_1.2fr_1.2fr_1.2fr_0.5fr_1.2fr_0.8fr] gap-4 items-center px-4 mb-2">
                            ...
                            <div className="flex flex-col pb-4">
                                {transactions.map((txn) => (
                                    <div
                                        key={txn.id}
                                        className="w-full min-h-[50px] grid grid-cols-[1.5fr_1.5fr_1.2fr_1.2fr_1.2fr_0.5fr_1.2fr_0.8fr] gap-4 items-center px-4 border-b border-[#5b616e33] last:border-0 hover:bg-[#eef0f3] transition-colors"
                                    >
                                        {/* TXN HASH */}
                                        ...
                                        {/* METHOD */}
                                        <div className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-[#0a0b0d] text-xs tracking-[0] leading-[normal] truncate text-center">
                                            {txn.method}
                                        </div>
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            />
                                            <span className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-[#0a0b0d] text-xs tracking-[0] leading-[normal] truncate">
                                                {txn.gasFee}
                                            </span>
                                        </div>
                                    </div>
