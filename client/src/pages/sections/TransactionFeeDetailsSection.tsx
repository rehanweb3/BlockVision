...
const feeRows = [
  ...
  },
  {
    label: "Gas Fees:",
    value: (
      <span className="[font-family:'Satoshi-Regular',Helvetica] font-normal text-white text-[13px]">
        Base:{" "}
          ...
          {feeRows.map((row, index) => (
            <div key={index}>
              ...
              <div className="flex flex-row items-start py-[14px] gap-4">
                <div className="w-[200px] shrink-0 [font-family:'Satoshi-Medium',Helvetica] font-medium text-white text-[13px] tracking-[0] leading-normal">
                  {row.label}
                </div>
                <div className="flex-1 [font-family:'Satoshi-Bold',Helvetica] font-bold text-white text-[13px] tracking-[0] leading-normal">
                  {row.value}
                </div>
              </div>
