...
export const BlockHashesSection = (): JSX.Element => {
  return (
    <div className="w-full flex justify-center shadow-shadow">
      <Card className="w-full bg-[#1f201e] rounded-2xl border border-solid border-[#2e2e2d] shadow-none">
          ...
          {blockHashRows.map((row, index) => (
            <div key={index} className="flex flex-col">
              ...
              <div className="flex flex-row items-center py-[14px] gap-4">
                {/* Label */}
                <span className="w-[210px] shrink-0 [font-family:'Satoshi-Medium',Helvetica] font-medium text-white text-[13px] tracking-[0] leading-[normal]">
                  {row.label}
                </span>
